...
- **Ink.** 1000 × 750 integer grid; ≤ 64 points per batch; ≤ 20,000 points per turn ("The napkin's full"); inks `black red orange yellow green blue purple brown white paper`; five sizes.
